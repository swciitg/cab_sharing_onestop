            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(":", style: TextStyle(color: Colors.white, fontSize: 20.0, fontWeight: FontWeight.bold),),
                  Container(
                    width: 70,
                    child: ListWheelScrollView.useDelegate(
                      itemExtent: 40,
                  ...
                  builder: (context) {
                    return DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        value: whereValue,
                        items: <String>["Airport", "Railway Station"].map((String val) {
                    ...
                    return DropdownButtonHideUnderline(
                      child: DropdownButton<String>(
                        ...
                        items: <String>[
                          ...
                          "${hoursValue.toString()}:${minutesValue.toString()} or 1 hr early",
                          "${hoursValue.toString()}:${minutesValue.toString()} or 2 hrs early"
                        ].map((String val) {
                          return DropdownMenuItem<String>(
                            value: val,
                            child: Text(val),
